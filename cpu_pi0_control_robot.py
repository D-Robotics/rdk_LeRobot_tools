...
def main():
    ...
    parser.add_argument('--ckpt-path', type=str, 
                        default='test_weights_0502/airbot_2camera_1_origin_pi0/010000', 
                        help='Path to LeRobot PI0 Policy model.')
    """ 
    # example: --ckpt-path
    ./pretrained_model/
    ├── config.json
    ...
    └── train_config.json
    """
    parser.add_argument('--fps', type=int, default=40, help='') 
    ...
    policy = PI0Policy.from_pretrained(opt.ckpt_path)
