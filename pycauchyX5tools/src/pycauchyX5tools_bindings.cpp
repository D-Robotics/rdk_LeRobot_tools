...
PYBIND11_MODULE(libpycauchyX5tools, m)
{
    // 添加模块元信息
    m.attr("__version__") = "0.0.0";                                                  // 版本号
    m.attr("__author__") = "Cauchy - WuChao in D-Robotics";                           // 作者
    m.attr("__date__") = "2025-04-22";                                                // 日期
    m.attr("__doc__") = "pycauchyX5tools: This module provides an interface for BPU_ACTPolicy_VisionEncoder and BPU_ACTPolicy_TransformerLayers."; // 模块描述
