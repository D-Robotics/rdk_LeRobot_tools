...
def main():
    ...
    float_onnx_visionEncoder = onnxruntime.InferenceSession("bpu_act_so100_0409/BPU_ACTPolicy_VisionEncoder/BPU_ACTPolicy_VisionEncoder.onnx")
    float_onnx_transformerLayers = onnxruntime.InferenceSession("bpu_act_so100_0409/BPU_ACTPolicy_TransformerLayers/BPU_ACTPolicy_TransformerLayers.onnx")
    
    policy = BPU_ACTPolicy("bpu_act_so100_0409/BPU_ACTPolicy_VisionEncoder/bpu_model_output/BPU_ACTPolicy_VisionEncoder.hbm", "bpu_act_so100_0409/BPU_ACTPolicy_TransformerLayers/bpu_model_output/BPU_ACTPolicy_TransformerLayers.hbm")
    
    for k in range(200):
        if k % 4 != 0:
            continue
        state = np.load("bpu_act_so100_0409/BPU_ACTPolicy_TransformerLayers/calibration_data_BPU_ACTPolicy_TransformerLayers/state/%.10d.npy"%k)
        phone = np.load("bpu_act_so100_0409/BPU_ACTPolicy_VisionEncoder/calibration_data_BPU_ACTPolicy_VisionEncoder/phone_%.10d.npy"%k)
        laptop = np.load("bpu_act_so100_0409/BPU_ACTPolicy_VisionEncoder/calibration_data_BPU_ACTPolicy_VisionEncoder/laptop_%.10d.npy"%k)
